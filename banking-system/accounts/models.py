...
class UserBankAccount(models.Model):
    ...
    def get_interest_calculation_months(self):
        ...
        # Determine starting month safely. Prefer explicit interest_start_date,
        # fall back to initial_deposit_date, otherwise default to January (1).
        if self.interest_start_date:
            start = self.interest_start_date.month
        elif self.initial_deposit_date:
            start = self.initial_deposit_date.month
        else:
            start = 1
